                    ...
                    <div class="header_top_wrapper d-flex justify-content-center justify-content-md-between">
                        ...
                        <div class="header_top_login">
                            <ul>
                                ...
                                <li>
                                    <a class="main-btn" href="#"><i class="fa fa-user-o"></i> Log In</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="navbar_meta">
                            <ul>
                                ...
                                <li>
                                    <a href="#"><img src="assets/images/cart.png" alt="cart" /> <span>0</span></a>
                                </li>
                            </ul>
                        </div>
                    </nav>
                        ...
                        <div class="col-lg-12">
                            <div class="slider_content text-center">
                                ...
                                <p data-animation="fadeInUp" data-delay="0.8s">
                                    Phasellus enim libero, blandit vel sapien vitae, condimentum ultricies magna <br />
                                    etquisque euismod orci ut et lobortis.
                                </p>
                        ...
                        <div class="single_courses mt-30">
                            ...
                            <div class="courses_content">
                                ...
                                <div class="meta d-flex justify-content-between">
                                    <ul>
                                        <li>
                                            <a href="#"><i class="fa fa-user-o"></i> 100</a>
                                        </li>
                                        <li>
                                            <a href="#"><i class="fa fa-star-o"></i> 4.5</a>
                                        </li>
                                    </ul>
                                    <span>$230</span>
                                </div>
                    ...
                    <div class="events_content bg_cover" style="background-image: url(assets/images/event-1.jpg);">
                        <div class="events_wrapper">
                            <ul class="events_meta">
                                <li>
                                    <a class="color-1" href="#"><i class="fa fa-calendar"></i> 09 Dec, 2019</a>
                                </li>
                                <li>
                                    <a class="color-2" href="#"><i class="fa fa-map-marker"></i>New york grand city 1247</a>
                                </li>
                            </ul>
                            <h4 class="events_title">
                                <a href="#">
                                    Conference for reducing global warming with mr <br />
                                    helmet
                                </a>
                            </h4>
                        </div>
                ...
                <div class="single_events d-flex flex-wrap">
                    <div class="events_content events_content_2 bg_cover" style="background-image: url(assets/images/event-1.jpg);">
                        <div class="events_wrapper">
                            ...
                            <h4 class="events_title">
                                <a href="#">
                                    Conference for reducing global warming with <br />
                                    mr helmet
                                </a>
                            </h4>
                        </div>
